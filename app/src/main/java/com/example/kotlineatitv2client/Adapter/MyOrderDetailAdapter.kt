...
class MyOrderDetailAdapter(internal var context: Context, internal var cartItemList:MutableList<CartItem>):
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        try {
            ...
            Log.d("abcd", "onBindViewHolder: json error = ${e.message}")
        }
